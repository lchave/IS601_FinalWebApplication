...
CREATE TABLE IF NOT EXISTS tblMovieImport (
...
INSERT INTO tblMovieImport (Year,Score,Title) VALUES
    (1968,  86,'Greetings'),
    (1970,  17,'Bloody Mama'),
    (1970,  73,'Hi, Mom!'),
    (1971,  40,'Born to Win'),
    ...
    (1994,  39,'Mary Shelleys Frankenstein'),
    (1995,  80,'Casino'),
    (1995,  86,'Heat'),
    (1996,  74,'Sleepers'),
    (1996,  38,'The Fan'),
    (1996,  80,'Marvins Room'),
    (1997,  85,'Wag the Dog'),
